...
class NewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'terms_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'terms_id' => 1,
            'created_at' => 1450320555,
            'deleted_at' => 1450320555
        ],
    ];
}
